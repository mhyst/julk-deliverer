...
public class SMTPTranslator extends Translator
{	
							  ...
							  String command, WorkResult wr)
	{
		...
		try {
			...
			_msgFile.write("From: Mailer <deliverer@mipc.zapto.org>\r\n".getBytes());
			...
			*/
			...
			SMTP smtp = new SMTP(mail.getSMTPserver(),mail.getSMTPport());
			smtp.helo("mailer");
